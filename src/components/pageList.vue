  ...
  export default {
    ...
    methods: {
      ...
      submit() {
        ...
        console.log(this.item)
        this.item[this.item.field.relationField] =
          this.templateRadio[this.item.field.relationField]
        this.item[this.item.field.bindCodeField] =
          this.templateRadio[this.item.field.bindCodeField]
        this.item.field[this.item.field.bindNameField] =
          this.templateRadio[this.item.field.bindNameField]
        this.$emit('submit')
        this.handleClose()
      },
    },
