...
// 获取公众号配置
export function getWechatAccounts (data) {
  return request({
...
// 设置公众号配置
export function setWechatAccounts (data) {
  return request({
    url: '/api/wechat/accounts/addOrUpdate',
    method: 'post',
    data
  })
}
...
export function getApplets (data) {
  return request({
    url: '/api/wechat/applets',
    data
  })
}

// 设置公众号配置
export function setApplets (data) {
  return request({
    url: '/api/wechat/applets/addOrUpdate',
    method: 'post',
    data
  })
}

// 获取聊天工具栏配置 toolAddOrUpdate
export function toolAddOrUpdate() {
  return request({
    url: service + '/findChatToolbarConfig',
  })
}
